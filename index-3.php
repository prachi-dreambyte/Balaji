...
<head>
    ...
    <body>
		...
		<div class="slider-and-banner-area">
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						<div class="slider-container">
							<div class="slider">
								...
								<div id="mainslider" class="nivoSlider slider-image">
									<img src="img/slider/3.jpg" alt="main slider" title="#htmlcaption1"/>
								...
								<div id="htmlcaption1" class="nivo-html-caption slider-caption-1">
									...
									<div class="slide1-text slide-1">
										<div class="middle-text color-black">
					...
					<div class="col-md-4 col-sm-12 col-xs-12">
						<div class="banner-right row">
							<div class="banner-box sm-mb-3 col-md-12 col-sm-6">
								<a href="#">
									<img src="img/banner/1_3.jpg" alt="" />
								</a>
							</div>
							<div class="banner-box col-md-12 col-sm-6">
								<a href="#">
									<img src="img/banner/2_3.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
		...
		<!-- service-start -->
		<div class="home-3-service service-area">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-12">
						<div class="feature-tab-area">
                            ...
                            <ul class="tabs" role="tablist">
    							<li><a class="active" href="#newarrival" role="tab" data-bs-toggle="tab">new arrival</a></li>
							    <li><a href="#onsale" role="tab" data-bs-toggle="tab">onsale</a></li>
							    <li><a href="#bestseller" role="tab" data-bs-toggle="tab">bestseller</a></li>
                            </ul>
									...
									<div class="row">
										<div class="product-carousel">
											...
											<div class="col-md-12">
												...
												<div class="single-product tab-mar">
													<div class="product-img">
														<a href="#">
											...
											<div class="col-md-12">
												...
												<div class="single-product tab-mar special-mar">
													<div class="product-img">
														<a href="#">
													...
													<div class="product-content">
														...
														<div class="price-box">
															...
															<span class="old-price"> £ 34.19 </span>
														</div>
													</div>
												</div>
											</div>
											...
											<div class="col-md-12">
												...
												<div class="single-product tab-mar">
													...
													<div class="product-content">
														<h5 class="product-name">
															<a href="#" title="PPrinted Chiffon Dress">Printed Chiffon Dress</a>
														</h5>
														<div class="reviews">
															<div class="star-content clearfix">
																<span class="star star-on"></span>
