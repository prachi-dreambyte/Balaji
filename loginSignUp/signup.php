...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($password !== $cpassword) {
        ...
        if ($account_type === 'personal') {
            ...
            $gst      = $_POST['gst']; // Required
            $pan      = !empty($_POST['pan']) ? $_POST['pan'] : NULL; // Optional
            $website  = $_POST['website'];
            $company_name = $_POST['company_name'];

            $sql = "INSERT INTO signup (company_name, name, email, phone, address, gst, pan, website, password, account_type)
                    VALUES ('$company_name', '$name', '$email', '$phone', '$address', '$gst', " . 
                    ($pan ? "'$pan'" : "NULL") . ", '$website', '$hashed_password', '$account_type')";
        }
...
<head>
    ...
    <title>Signup Page || Balaji</title>
    ...
    <div class="container">
        ...
        <form action="" method="POST" id="personalForm" class="signup-form active">
            ...
            <div class="form-group text-center mt-3">
                <a href="login.php" class="fw-bold text-primary text-decoration-none">← Back to Login</a>
            </div>
        </form>
