				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-12 banner-area-box">
						<div class="banner-box">
							<div class="banner-content">
								<h2>01.</h2>
								<h3>Classic<br>Desk Lamp</h3>
								<p>Curabitur sit amet enim sodales nisl efficitur porttitor. 
								Donec ac turpis diam. Mauris interdum magna eu neque convallis, 
								vel laoreet lectus ultrices.</p>
								<a href="#">Shop now</a>
							</div>
							<div class="banner-picture">
								<a href="#">
									<img src="img/banner/5_1.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="banner-box">
							<div class="banner-picture">
								<a href="#">
									<img src="img/banner/4_1.jpg" alt="" />
								</a>
							</div>
							<div class="banner-content">
								<h2>02.</h2>
								<h3>Bamboo<br>basket</h3>
								<p>Pellentesque eu porttitor magna. Donec aliquet elementum eros, 
								et elementum purus varius sit amet.</p>
								<a href="#">Shop now</a>
							</div>
						</div>
					</div>
				...
				<div class="row banner-marg">
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="banner-static-box no-mar">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/6_1.jpg" alt="" />
								</a>
							</div>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="banner-static-box">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/7_1.jpg" alt="" />
								</a>
							</div>
							<div class="banner-box-content">
								<h2>04.</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="banner-static-box">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/8_1.jpg" alt="" />
								</a>
							</div>
							<div class="banner-box-content">
								<h2>05.</h2>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="feature-tab-area">
                            <!-- Nav tabs -->
							<ul id="tabs" class="tabs nav tabs-featured tab_categorys" data-tabs="tabs"> 
								<li><a class="active" href="#newarrival" data-bs-toggle="tab">new arrival</a></li>
								<li><a href="#onsale" data-bs-toggle="tab">men</a></li>
								<li><a href="#bestseller" data-bs-toggle="tab">men</a></li>
							</ul>
							<div class="tab_container tab-content owl-carousel-space">
								<div class="tab-pane show active" id="newarrival">
									<div class="row">
									...
									<div class="col-md-12">
										<div class="item-product item-pro-mar">
											...
											<div class="product-contents">
												<h5 class="product-name">
													<a href="#" title="Faded Short Sleeves T-shirt">Printed Dress</a>
												</h5>
												<div class="reviews">
													<div class="star-content clearfix">
														<span class="star star-on"></span>
								...
								<div class="col-md-12">
									<div class="single-blog">
										...
										<div class="blog-content">
											<h4 class="blog-title">
												<a href="#">Share the Love 1.6 Responsive design</a>
											</h4>
