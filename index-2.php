    ...
    <body>
				...
				<div class="row">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="banner-static-box">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/1_2.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="banner-static-box">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/2_2.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="banner-static-box">
							<div class="banner-box">
								<a href="#">
									<img src="img/banner/3_2.jpg" alt="" />
								</a>
							</div>
						</div>
					</div>
										...
										<div class="col-md-12">
											<div class="single-product">
												<div class="daily-products">
													...
													<div class="upcoming">
														<span class="is-countdown"> </span>
														<div data-countdown="2023/06/01"></div>
													</div>	
												</div>
											</div>
										</div>
		...
		<div class="home-2-product-tab">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="feature-tab-area owl-carousel-space">
                            <!-- Nav tabs -->
                            ...
                            <div class="tab-content">
								<div role="tabpanel" class="tab-pane active show fade" id="newarrival">
									<div class="row">
		...
		<!-- product-tab-end -->
		<!-- service-start -->
		<div class="home-2-service service-area">
			<div class="container">
				<div class="row">
