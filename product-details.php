...
if (session_status() === PHP_SESSION_NONE)
	session_start();
include 'connect.php';
// 2. USER ACCOUNT TYPE (for special pricing)
...
// 5. FETCH PRODUCT DETAILS & VARIANTS
if ($product_id > 0) {
	...
	if ($row) {
		...
		// If not found, try home_daily_deal table
								...
								<div class="variant-options" style="display: flex; gap: 10px; flex-wrap: wrap;">
									...
									<?php if (!empty($main_color)): ?>
										<div class="variant-item main-product-color"
											...
											<?php endif; ?>
											<div style="font-size:13px; margin-top:5px;"><?= htmlspecialchars($main_color); ?>
											</div>
										</div>
									<?php endif; ?>
										...
										<?php foreach ($variants as $variant): ?>
											...
											<div class="variant-item" data-variant-id="<?= htmlspecialchars($variant['id']); ?>"
												...
												<div style="font-size:13px; margin-top:5px;">
													<?= htmlspecialchars($variant['color'] ?? ''); ?></div>
											</div>
										<?php endforeach; ?>
									<?php endif; ?>
						...
						<div class="feature-tab-area">
							...
							<div class="tab-content">
								...
								<div role="tabpanel" class="tab-pane active fade show" id="moreinfo">
									<div class="tab-box">
										<div class="more-info">
											<p><?php echo $product['description'] !== '' ? nl2br(htmlspecialchars($product['description'])) : '---'; ?>
											</p>
										</div>
									</div>
								</div>
