					...
					<div class="col-md-5 col-sm-6 col-xs-12">
						<div class="picture-tab">
                            ...
                            <ul class="pic-tabs nav" role="tablist">
    							<li><a class="active" href="#picture-1" aria-controls="picture-1" role="tab" data-bs-toggle="tab"><img src="img/tab-pro/1.jpg" alt="" /></a></li>
							    <li><a href="#picture-2" aria-controls="picture-2" role="tab" data-bs-toggle="tab"><img src="img/tab-pro/2.jpg" alt="" /></a></li>
							    <li><a href="#picture-3" aria-controls="picture-3" role="tab" data-bs-toggle="tab"><img src="img/tab-pro/3.jpg" alt="" /></a></li>
							    <li><a href="#picture-4" aria-controls="picture-4" role="tab" data-bs-toggle="tab"><img src="img/tab-pro/5.jpg" alt="" /></a></li>
                            </ul>
								...
								<div role="tabpanel" class="tab-pane active fade show" id="moreinfo">
									<div class="tab-box">
										<div class="more-info">
											...
											which have since evolved into a full ready-to-wear collection in which every item is a vital part of a woman's wardrobe. The result? Cool, easy, chic 
											looks with youthful elegance and unmistakable signature style. All the beautiful pieces are made in Italy and manufactured with the greatest attention. 
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="product-title">
							<h2>
								<span>12 other products in the same category: </span>
							</h2>
						</div>
						<div class="owl-carousel-space">
							<div class="row">
