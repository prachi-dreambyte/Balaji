				...
				<div class="row">
					<div class="col-md-12">
						<div class="four-zero-content">
							...
							<a href="index11.php">back to home page</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-6 col-sm-6 col-xs-12 address">
								Copyright  © <a href="http://bootexperts.com/">Bootexperts</a>. All Rights Reserved
							</div>
