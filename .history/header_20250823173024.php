...
<style>
    ...
    .gradient-blue { background: linear-gradient(135deg, #cceaff, #99d6ff); }
    .gradient-brown { background: linear-gradient(135deg, #f5d2b0, #e8b27a); }
    .gradient-purple { background: linear-gradient(135deg, #e5ccff, #c299ff); }
    .gradient-green { background: linear-gradient(135deg, #e0f8d8, #a8e6a3); }
    .gradient-yellow { background: linear-gradient(135deg, #fff3c2, #ffe699); }
    .gradient-orange { background: linear-gradient(135deg, #ffd6b3, #ffb366); }
    .gradient-default { background: linear-gradient(135deg, #f0f0f0, #cccccc); }
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Fix for dropdown staying visible when moving from category text to dropdown
        const categoryLink = document.getElementById('categoryLink');
        const categoryMenu = document.getElementById('categoryMenu');
        
        if (categoryLink && categoryMenu) {
            // Add a small gap between the category link and dropdown
            const gapElement = document.createElement('div');
            gapElement.style.height = '15px';
            gapElement.style.position = 'absolute';
            gapElement.style.top = '100%';
            gapElement.style.left = '0';
            gapElement.style.width = '100%';
            categoryLink.parentNode.appendChild(gapElement);
            
            // Make sure dropdown stays visible when moving to it
