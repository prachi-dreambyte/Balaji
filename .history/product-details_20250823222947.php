...
$product_id = $product['id']; // Ensure correct field name
...
<div class="abc">
    ...
    <div class="product-rating" style="margin:6px 0;">
        <?= str_repeat('<span style="color:#FFD700;">★</span>', $product['rating']) ?>
        <?= str_repeat('<span style="color:#ccc;">☆</span>', 5 - $product['rating']) ?>
        ...
        <?php else: ?>
            <span class="no-reviews" style="margin-left:8px; color:#999;">
                No reviews yet
            </span>
        <?php endif; ?>
    </div>
