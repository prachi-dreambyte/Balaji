...
z
                // Show first tab by defaultz
                document.querySelector('.tab-pane').classList.add('active');z
z
                tabBtns.forEach(btn => {z
                    btn.addEventListener('click', function () {z
                        // Remove active class from all buttons and panesz
                        tabBtns.forEach(b => b.classList.remove('active'));z
                        tabPanes.forEach(pane => pane.classList.remove('active'));z
z
                        // Add active class to clicked buttonz
