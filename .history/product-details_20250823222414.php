...
$product_id = $product['id']; // Ensure correct field
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7 col-sm-6 col-12 shop-content">
					...
					<div class="abc">
    <h1>
        <?php echo $product['product_name'] !== '' ? htmlspecialchars($product['product_name']) : '---'; ?>
						</h1>
						...
						<div class="product-rating">
							<?php if ($product['rating'] > 0): ?>
								<span class="stars">
									...
									for ($i = 1; $i <= 5; $i++) {
										if ($i <= $product['rating']) {
											echo '<i class="fa fa-star" style="color:#FFD700;"></i>'; // filled star
										} else {
											echo '<i class="fa fa-star-o" style="color:#FFD700;"></i>'; // empty star
										}
									}
									?>
								</span>
						...
						<h4>
							<?php echo $product['short_description'] !== '' ? htmlspecialchars($product['short_description']) : '---'; ?>
						</h4>
					</div>
