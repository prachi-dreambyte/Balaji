  ...
  <div class="mega-menu" id="categoryMenu">
    ...
    <div class="category-column">
      ...
      <ul class="category-list">
        <?php
        $sql = "SELECT category_name, category_image FROM categories 
                WHERE category_name LIKE '%Chair%' OR category_name LIKE '%Office%'
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          ...
          echo '<li>No Office Chair Categories</li>';
        }
        ?>
      </ul>
    </div>

    <!-- Plastic Items Column -->
    <div class="category-column">
      <h3>Plastic Chairs & Tables</h3>
      <ul class="category-list">
        <?php
        $sql = "SELECT category_name, category_image FROM categories 
                WHERE category_name LIKE '%Plastic%'
                ORDER BY category_name ASC";
        $result = mysqli_query($conn, $sql);
        ...
        if ($result && mysqli_num_rows($result) > 0) {
          ...
          echo '<li>No Plastic Categories</li>';
        }
        ?>
      </ul>
    </div>
