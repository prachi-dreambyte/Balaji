...
?>
    ...
    <h5 class="product-name" style="margin-bottom:8px; font-size:16px; font-weight:600; color:#222;">
        <a href="product-details.php?id=<?php echo $row['id']; ?>"
				...
				<!-- ⭐ Reviews Section -->
				<div class="reviews" style="margin-bottom:8px;">
					<div class="star-content clearfix" style="display:inline-block; margin-right:6px;">
	<?php
							if (!empty($avg_rating)) {
								for ($i = 0; $i < 5; $i++) {
									if ($i < round($avg_rating)) {
										echo '<span class="star star-on" style="color:#FFD700; font-size:14px;">★</span>';
									} else {
										echo '<span class="star" style="color:#ccc; font-size:14px;">★</span>';
									}
								}
							} else {
								// if no rating yet
					...
					<div class="comment" style="display:inline-block; font-size:13px; color:#666;">
				...
				<div class="price-box" style="margin-bottom:8px;">
					...
					<div>
						<span class="price" style="font-size:18px; font-weight:700; color:#222;">
