...
.mega-menu {
    ...
    z-index: 1000;
    min-width: max-content; /* auto width, expands with categories */
...
.category-list {
    ...
    margin: 0;
    display: flex;
    flex-direction: column; /* stacked dropdown */
    gap: 8px;
}
...
<header class=" header-section">
    ...
    <div class="mega-menu" id="categoryMenu">
        <?php
        $sql = "SELECT id, category_name, category_image FROM categories ORDER BY category_name ASC";
