...
if ($resultss = $conn->query($sql)) {
    while ($rowss = $resultss->fetch_assoc()) {
        $activities[] = [
            'action' => $rowss['action'],
            'ref' => $rowss['ref'],
            'time' => date("l, d M Y h:i A", strtotime($rowss['created_at']))
        ];
    }
} else {
...
<div class="main-nav">
    ...
    <div class="scrollbar" data-simplebar>
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarHome-testimonials" data-bs-toggle="collapse" role="button"
                    aria-expanded="false" aria-controls="sidebarHome-testimonials">
                    <span class="nav-icon">
                        <iconify-icon icon="solar:bag-smile-bold-duotone"></iconify-icon>
                    </span>
