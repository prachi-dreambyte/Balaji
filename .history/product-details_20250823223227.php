		...
		<div class="container">
          ...
          WHERE product_id = $product_id";
					...
					<div class="abc">
						...
						<div class="product-rating" style="display:flex; align-items:center; gap:8px; margin:8px 0;">
    
    <!-- Average Rating Number -->
    <span class="avg-rating" 
          style="font-size:18px; font-weight:600; color:#222;">
        <?= $avg_rating; ?>
							</span>
						
							<!-- Stars -->
							<span class="stars" style="font-size:16px; color:#FFD700; letter-spacing:2px;">
								<?= renderStars($avg_rating); ?>
							</span>
						
							<!-- Review Count -->
							<span class="review-count" style="font-size:14px; color:#666; margin-left:6px;">
