        ...
        <div class="row text-center">
            <div class="col-md-4 col-md-offset-2 col-sm-6 col-xs-12 mb-3">
                <div class="bounceInLeft animated">
                    <img src="images/d1.jpg" alt="Distributor 1" class="img-responsive img-fluid" id="d_img" style="max-width:100%; border-radius:10px;">
                </div>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 mb-3">
                <div class="bounceInRight animated">
                    <img src="images/d2.jpg" alt="Distributor 2" class="img-responsive img-fluid" id="d_img" style="max-width:100%; border-radius:10px;">
                </div>
            </div>
        </div>
    </div>
                                                        ...
                                                        <div class="product-content">
                                                            ...
                                                            <div class="product-rating">
                                                                ...
                                                                <?php if ($product['review_count'] > 0): ?>
                                                                    <span class="review-count"><?= $product['review_count'] ?>
                                                                        Review(s)</span>
                                                                <?php endif; ?>
                                                            </div>
