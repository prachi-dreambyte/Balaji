...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    $avg_rating = round($reviewData['avg_rating'], 1); // one decimal
...
if ($avg_rating >= 4) {
    ...
    $badgeColor = "#999"; // grey for no rating
}
?>
...
<div class="abc">
    ...
    <div class="product-rating" style="display:flex; align-items:center; gap:10px; margin:8px 0;">
        <?php if ($review_count > 0): ?>
			<!-- Badge -->
			<span class="rating-badge" style="background:<?= $badgeColor ?>; color:#fff;
							 padding:2px 6px; border-radius:2px;
							 font-size:11px; font-weight:600;
							 display:inline-flex; align-items:center; gap:4px;">
				<?= $avg_rating ?> <span style="font-size:13px;">★</span>
			</span>
	
			<!-- Review Count -->
			<span class="review-count" style="font-size:14px; color:#555;">
		...
		<?php endif; ?>
					...
					<div style=" font-weight: 500; color:green"; ><p>Special Price</p></div>
						...
						<div class="content-price">
							...
							<?php if ($total_discount > 0 || $discount_percent > 0): ?>
								<div style="display:flex; align-items:center; gap:12px; margin:5px 0;">
							
									<?php if ($total_discount > 0): ?>
										<span class="old-price" style="text-decoration:line-through; color:#999; font-size:14px;">
											₹<?php echo number_format($old_price, 2); ?> <span class="price-tax">tax incl.</span>
										</span>
									<?php endif; ?>
							
									<?php if ($discount_percent > 0): ?>
										<span class="reduction-percent" style="color:black; font-weight:800; font-size:12px;">
