        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
            ...
            <nav class="d-none d-xl-flex flex-wrap justify-content-center gap-3 flex-grow-1">
                <p class="headerText"><a href="index.php"
                        class="nav-link <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">HOME</a></p>
                ...
                <p class="headerText"><a href="about-us.php"
                        class="nav-link <?php echo ($current_page == 'about-us.php') ? 'active' : ''; ?>">ABOUT US</a></p>
                <p class="headerText"><a href="blog.php"
                        class="nav-link <?php echo ($current_page == 'blog.php') ? 'active' : ''; ?>">BLOG</a></p>
                <p class="headerText"><a href="contact.php"
                        class="nav-link <?php echo ($current_page == 'contact.php') ? 'active' : ''; ?>">CONTACT</a></p>
            </nav>
            ...
            <div class="d-flex align-items-center gap-3 flex-wrap justify-content-end">
                ...
                <?php if (!empty($_SESSION['user'])): ?>
                    <a href="logout.php" class="d-flex align-items-center header-Side text-black"><i
                            class="fas fa-lock me-1"></i> Log Out</a>
                <?php else: ?>
                    <a href="loginSignUp/login.php" class="d-flex align-items-center header-Side text-black"><i
                            class="fas fa-lock me-1"></i> Log In</a>
                <?php endif; ?>
            </div>
                    ...
                    <?php foreach ($groups as $mainTitle => $items): ?>
                        <div class="mt-2" style="padding:8px 0;">
                            <div style="font-weight:700; font-size:14px; padding:6px 0; border-bottom:1px solid #eee;">
                                <?php echo htmlspecialchars($mainTitle); ?></div>
                            <?php foreach ($items as $it):
                                $name = htmlspecialchars($it['name']);
                                $imagePath = categoryImagePath($it['image']);
                                ?>
