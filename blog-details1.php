...
<section>
    <div class="container">
        <div class="row">
            <div class="left-column-block col-md-9 col-sm-9 pt-5">
                <div class="single-blog blog-margin">
                  <img src="img\balaji\postbox-01 (1).jpg"/>
                </div>
                <div>
                ...
                <h1 class="AboutfirstHeading">Why Bala Ji Furniture is the best choice?</h1>
                <p class="aboutpUniversalPara">
                    ...
                    <ol>
                        <li>
                            <h4>Made for everyday comfort</h4>
                             <p class="aboutpUniversalPara">Whether you seat someone at your home, garden, office or event sace, our plastic chairs are designed to fit them. Because they have soft surfaces, robust back support and are created with ergonomics in mind,
                               Spark Line chairs are designed for daily use. Don't creak. No pain. Every single day, just a basic comfort.</p>
                        </li>
                        <li>
                ...
                <div class="BlogDetailImage">
                    <img src="img\balaji\postbox-04.jpg" class="BlogAboutImage "/></div>
                    <img src="img\balaji\postbox-05.jpg" class="BlogAboutImage"/></div>
                </div>
                <div>
